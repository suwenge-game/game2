    ...
    return [
        {
            ...
            description: "穿梭未知星球并应对外星生物，合理规划航线与补给才能完成这场太空冒险。",
            category: "action",
        ...
        },
        {
            ...
            title: "Sudoku Master",
            image_url: "assets/images/fallback-game-card.png",
            description: "从基础宫格到高难题面逐步推演，数独训练帮助玩家磨炼排除法与逻辑判断。",
            category: "puzzle",
...
function createGameCard(game) {
    ...
    const actionLinkHtml = detailUrl ? `
                <a class="play-btn" href="${detailUrl}">
                    <i class="fas fa-book-open"></i> Read Guide
                </a>` : `
                <a class="play-btn" href="${game.game_link}" target="_blank" rel="nofollow noopener">
                    <i class="fas fa-external-link-alt"></i> Play on partner site
                </a>`;
